                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 gap-4 w-full mx-auto max-w-6xl">
                    <BlurFade delay={BLUR_FADE_DELAY * 4}>
                      <div className="border border-border bg-background rounded-lg p-6 hover:shadow-lg hover:ring-2 hover:ring-muted/50 hover:bg-background/70 transition-all">
                        <AchievementCard
                          index={0}
